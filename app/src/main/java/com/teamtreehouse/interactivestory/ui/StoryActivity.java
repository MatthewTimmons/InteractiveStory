...
public class StoryActivity extends AppCompatActivity {
    ...
    private final static String EXTRA_NAME = "extraName";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (name == null || name.isEmpty()) {
            name = getResources().getString(R.string.defaultName);
        }
    ...
    private void presentPage(int pageNumber) {
        ...
        // Add the name if the placeholder included. Won't add if not
    ...
    private void presentButtons(final Page page) {
